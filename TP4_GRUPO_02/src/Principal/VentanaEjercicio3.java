...
public class VentanaEjercicio3 extends JFrame {
	...
	public VentanaEjercicio3() {
        ...
        panelEsp.setBorder(BorderFactory.createTitledBorder("")); // Borde vacï¿½o, como en la imagen
        ...
        panelHoras.setBorder(BorderFactory.createTitledBorder("")); // Borde vacï¿½o, como en la imagen
