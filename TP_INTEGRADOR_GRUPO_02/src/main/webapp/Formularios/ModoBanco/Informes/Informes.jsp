...
<div class="container mt-5">
    ...
    <div class="d-flex justify-content-center gap-3 flex-wrap">
        ...
        <button class="btn btn-custom btn-informe" data-bs-toggle="modal" data-bs-target="#modalInformeN3">Reporte N°1</button>
    </div>
</div>

<!-- Modal Informe 1: Provincias con más clientes -->
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white">
        <h5 class="modal-title" id="modalInformeN1Label">Informe N°1 - Top Provincias con más clientes</h5>
...
<!-- Modal Informe 2: Distribución por sexo -->
<div class="modal fade" id="modalInformeN2" tabindex="-1" aria-labelledby="modalInformeN2Label" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white">
        <h5 class="modal-title" id="modalInformeN2Label">Informe N°2 - Distribución de clientes por género</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <ul class="list-group">
...
<!-- Modal Informe 3 -->
<div class="modal fade" id="modalInformeN3" tabindex="-1" aria-labelledby="modalInformeN3Label" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <form action="InformesServlet" method="get">
        <div class="modal-header bg-danger text-white">
          <h5 class="modal-title" id="modalInformeN3Label">Reporte N°1 - Movimientos entre fechas</h5>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <div class="row mb-3">
...
%>
    <h5 class="mt-4">Movimientos encontrados:</h5>
...
%>
    <p class="text-warning mt-4">No se encontraron movimientos en el rango seleccionado.</p>
<% } %>
